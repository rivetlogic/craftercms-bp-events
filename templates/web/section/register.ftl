...
<!-- =========================
   REGISTER SECTION
============================== -->
<section id="${model['internal-name_t']}" class="parallax-section register-section" style="background: url('${model.bgImage_s!""}') 50%;">
    <div class="container">
            ...
            <div class="wow fadeInUp col-md-5 col-sm-5" data-wow-delay="1s">
                <form action="/api/1/services/register.json" method="post">
                    <#if (model.formFields_o.item)??><#list model.formFields_o.item as field>
                        <input name_t="${field.name_t}" class="form-control" id="${field.name_t}" placeholder="${field.label}" required="" ${field.label?contains("mail")?then('type="email"','type="text" ')}>
                    </#list></#if>
                    <div class="col-md-offset-6 col-md-6 col-sm-offset-1 col-sm-10">
                        <input name_t="submit" type="submit"
